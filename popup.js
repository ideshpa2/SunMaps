    ...
    function findMap() {
        ...
        if (mapContainer) {
            ...
            for (var key in window) {
                if (window[key] instanceof L.Map && mapContainer.id === window[key]._container.id) {
    ...
    image.onload = function() {
        ...
        if (map) {
            map.on('click', function(e) {
                ...
                var LCZcoords = map_to_image_coords(lat, lon, [[32.651710000000001, -112.82271], [34.09861, -111.14831]], [image.width, image.height]);
                ...
                L.popup()
                    .setLatLng(e.latlng)
                    .setContent("Climate Zone: " + zone + "<br>Mean Radiant Temperature: " + temperature + "°C")
                    .openOn(map);
            });
        } else {
